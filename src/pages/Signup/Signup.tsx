    ...
    <div className={styles.SignUp}>
      <div className={styles.SignupLeft}>
        ...
        <div className={styles.infoBlock}>
          ...
          <div>
            <h3>Əməkdaşlıq</h3>
            <p>STP Şirkətlər Qrupunda 2000-dən çox işçi kollektivi ilə yüksək komanda ruhunda əməkdaşlıq</p>
          </div>
        </div>
        <div className={styles.infoBlock}>
          <FaUserFriends />
      ...
      <div className={styles.formContainer}>
        <div className={styles.header}>
          <img src="src/assets/stpmmc.png" alt="STP MMC" />
        ...
        <form method="POST" encType="multipart/form-data" onSubmit={handleSubmit}>
          <div className={styles.inputGroup}>
            <label>Ad</label>
            <div className={`${styles.inputWrapper} ${errors.name ? styles.errorBorder : ''}`}>
              <FaUser />
          ...
          <div className={styles.inputGroup}>
            <label>Soyad</label>
            <div className={`${styles.inputWrapper} ${errors.surname ? styles.errorBorder : ''}`}>
              <FaUser />
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={`${styles.inputWrapper} ${errors.confirm_password ? styles.errorBorder : ''}`}>
              <FaLock />
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={`${styles.inputWrapper} ${errors.phone ? styles.errorBorder : ''}`}>
              <FaPhone />
          ...
          <div className={styles.inputGroup}>
            ...
            <div className={`${styles.inputWrapper} ${errors.id_serial ? styles.errorBorder : ''}`}>
              <FaIdCard />
              <input name="id_serial" type="text" value={formData.id_serial} onChange={handleChange} />
            </div>
            {errors.id_serial && <span className={styles.error}>{errors.id_serial}</span>}
          </div>

          <div className={styles.inputGroup}>
            <label>CV (PDF/DOC)</label>
            <div className={`${styles.inputWrapper} ${errors.cv ? styles.errorBorder : ''}`}>
              <FaFileAlt />
              <input
                name="cv"
                type="file"
        ...
        <div className={styles.signupLink}>
          <p>Hesabınız var? <Link to="/signin">Daxil olun</Link></p>
        </div>
      </div>
    </div>
  )
