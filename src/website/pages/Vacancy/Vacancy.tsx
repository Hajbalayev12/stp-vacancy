...
<div className={styles.extraImageSection}>
  ...
  <div className={styles.imageRow}>
    <img src="src/website/assets/image.png" alt="Əlavə Şəkil" className={styles.extraImage} />
    <img src="src/website/assets/NDT.png" alt="Əlavə Şəkil" className={styles.extraImage} />
    <img src="src/website/assets/NDT-Technician-Training.jpg" alt="Əlavə Şəkil" className={styles.extraImage} />
  </div>
</div>
      ...
      <div className={styles.shareButton}>
        <span>Paylaş</span>
        <svg className={styles.shareIcon} width="26" height="26" viewBox="0 0 24 24" fill="none">
          <path
      ...
      <div className={styles.tooltip}>
        ...
        <div className={styles.icons}>
          <a href="https://x.com/" className={styles.twitter}><FaTwitter /></a>
          <a href="https://www.facebook.com/" className={styles.facebook}><FaFacebookF /></a>
          <a href="https://www.linkedin.com/" className={styles.linkedin}><FaLinkedinIn /></a>
        </div>
      </div>
    </div>
